...
require([
  "swiper-bundle.min",			//スライダーJS
	...
	const mySwiperTypeBasic02 = new Swiper('.sliderBox--typeBasic.--typeVoice .swiper', {
		slidesPerView: 1,
		spaceBetween: 0,
		grabCursor: true,
		pagination: {
			el: '.sliderBox--typeBasic.--typeVoice .swiper-pagination',
			clickable: true,
		},
	    	navigation: {
	      		nextEl: '.sliderBox--typeBasic.--typeVoice .swiper-button-next',
	      		prevEl: '.sliderBox--typeBasic.--typeVoice .swiper-button-prev',
	    	},
	    	breakpoints: {
	      		800: {
	        		slidesPerView: 3,
